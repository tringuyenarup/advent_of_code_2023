...
mod tests {
    use super::*;
    const TEST_INPUT: &str = include_str!("../../inputs/day-10-test.txt");
    #[test]
    fn test_input() {
    ...
    #[test]
    fn test_part_1() {
        assert_eq!(part_1(include_str!("../../inputs/day-10.txt")).unwrap(), 1);
    }

    #[test]
    fn test_part_2() {
        assert_eq!(part_2(include_str!("../../inputs/day-10.txt")).unwrap(), 1);
    }
}
